...
def add(num1, num2):
    return "계산 결과 " , num1 + num2   # 튜플로 패킹했기때문에 오류x
...
#  함수에서 넓이 구하는 계산식 있어야하고 출력도 있어야 한다.
...
# if login_check(id,pw):      # 여기 부분을 함수로 처리될 수 있게
#     print("로그인 성공 하였습니다.")
# else:
#     print("아이디 또는 비밀번호를 잘못 입력하였습니다.")

# 문제 3. 상품의 재고를 확인하여 재고 충분, 재고 부족, 품절 이라고 출력할 수 있는 함수 만들기
...
# 위 코드 print( 함수 호출 ) 이렇게 실행하면 동작할 수 있게 함수 만드세요
