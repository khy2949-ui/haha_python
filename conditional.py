...
# 변수 apple의 값이 10이상이라면 1봉지 8000원이라고 출력
...
# word안에 동렬 이름이 없다라는 것을 확인할 수 있는 코드를 만드세요
if '동렬' not in word:
    print("없다")
...
text2 = "  "
text3 = "fourM22"
print(text1.isalpha())  # 문자만 있는지를 확인
print(text2.isspace())  # 공백만 있는지를 확인
print(text3.isalnum())  # 문자+숫자인지를 확인

# 문자열 정렬
text = "15"
print(text.zfill(6))    # 함수()안에 자릿수 넣기
print(text.rjust(4))    # 오른쪽 기준
print(text.ljust(5))    # 왼쪽 기준

# 문제1. - 공백제거와 소문자변환을 하려면??
...
# 위 4만 가능하다 input으로 메일을 입력받아서 가입 가능인지 불가능인지 출력
